...
Description:
    ...
    average counts of each FB energy channel for each timestep.
...
filename = 'FU3_2018-09-19_0756-0800.txt'
outfile = 'sec-avg_FU3-2018-09-19_0756-0800.txt'
