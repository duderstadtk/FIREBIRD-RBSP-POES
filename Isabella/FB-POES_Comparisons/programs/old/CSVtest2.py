...
for row in f_reader:
    ...
    if count == 0:
            ...
            new_time = last_time
            oldcount_second = new_time.second
            count_second = new_time.second
...
'''.format(
    ...
    print('test 5')
    new_time = datetime.datetime.strptime(row[count], '%Y-%m-%dT%H:%M:%S.%fZ')
    count_second = new_time.second
    print('this is count second')
    print(count_second)
    print('this is new time')
    print(new_time)
    count += 1
    print('test 6')
    print('this is count')
...
count_second += 1
last_time = current_time
print('this is count_second += 1')
print(count_second)
print('this is current time - last time')
...
'''   
when seconds increase by 1, trigger loop to start
data should be broken up by the second
i.e:

2018-09-18 01:34:55.762000    
2018-09-18 01:34:55.812000
2018-09-18 01:34:55.862000
2018-09-18 01:34:55.912000
2018-09-18 01:34:55.962000
averages from '2018-09-18 01:34:55.762000' to '2018-09-18 01:34:55.962000'
    *averages for each energy level listed here*

2018-09-18 01:34:56.012000
2018-09-18 01:34:56.062000
2018-09-18 01:34:56.112000
2018-09-18 01:34:56.162000
2018-09-18 01:34:56.212000
2018-09-18 01:34:56.262000
2018-09-18 01:34:56.312000
2018-09-18 01:34:56.362000
2018-09-18 01:34:56.412000
2018-09-18 01:34:56.462000
2018-09-18 01:34:56.512000
2018-09-18 01:34:56.562000
2018-09-18 01:34:56.612000
2018-09-18 01:34:56.662000
2018-09-18 01:34:56.712000
2018-09-18 01:34:56.762000
2018-09-18 01:34:56.812000 
averages from '2018-09-18 01:34:56.012000' to '2018-09-18 01:34:56.812000'
    *averages for each energy level listed here*
    
etc. etc.

round milliseconds to zero for each section so that it reads:
    averages for '2018-09-18 01:34:55.00'
        *averages for each energy level listed here*
    
    averages for '2018-09-18 01:34:56.00'
        *averages for each energy level listed here*
