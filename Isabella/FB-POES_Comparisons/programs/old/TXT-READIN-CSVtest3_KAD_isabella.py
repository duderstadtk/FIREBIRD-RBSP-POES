'''
Filename:
    TXT-READIN-CSVtest3_KAD.py   ---> this is a temporary name
...
#calculates average of FB counts for each energy channel and saves output to .txt file
...
def main():
    ...
    np.savetxt('example_averages.txt', np.column_stack(calc_average(data)), fmt='%s', delimiter=', ')
    print('Complete.')
