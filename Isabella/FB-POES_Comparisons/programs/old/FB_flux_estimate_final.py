...
Description:
    This program uses the minimum chi-squared value from the curve of best fit
    of FB hi-res data to calculate the best parameters for each timestep.
...
outfile = 'flux-params_FU3-2018-09-19_0756-0800.txt'
...
def calculate_flux(GfactorList, countList):
    ...
    return flux0, flux1, flux2, flux3, flux4, fluxArray, measuredcountsArray, timestepList
...
def main():
    ...
    flux_0, flux_1, flux_2, flux_3, flux_4, flux_array, measuredcounts_array, timestep_list = calculate_flux(Gfactor_var, counts_var)
    ...
    #---- curve fit ----#  
        popt, pcov = curve_fit(func, channel_middles, flux_array[timestep,:])
