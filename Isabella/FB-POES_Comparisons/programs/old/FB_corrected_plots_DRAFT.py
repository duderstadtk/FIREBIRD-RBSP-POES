...
def plot_data(data, xArray, yArray):
    ...
    plt.setp(lines[2], linewidth=0.5, color='g')
    plt.setp(lines[3], linewidth=0.5, color='c')
    plt.setp(lines[4], linewidth=0.5, color='b')
    plt.setp(lines[5], linewidth=0.5, color='m')
