...
Description:
    This program calculates the minimum chi-squared value between measured and
    estimated FB counts.
...
filename2 = 'sec-avg_FU3_2018-09-22_1945-1948.txt'
...
def main():
    ...
    np.savetxt('flux-params_FU3_2018-09-22_1945-1948.txt', np.column_stack(full_data), fmt='%s', delimiter=', ')
    print('Complete.')
